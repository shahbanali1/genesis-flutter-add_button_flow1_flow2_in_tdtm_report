...
//                         */
        ...
        // int maxTotal;
        // if (currentTotal_or_Date1 > prevTotal_or_Date2 &&
        //     currentTotal_or_Date1 > lastTotal_or_Date3 &&
        //     currentTotal_or_Date1 > secondLastTotal_or_Date4) {
        //   maxTotal = currentTotal_or_Date1;
        // } else if (prevTotal_or_Date2 > lastTotal_or_Date3 &&
        //     prevTotal_or_Date2 > secondLastTotal_or_Date4) {
        //   maxTotal = prevTotal_or_Date2;
        // } else if (lastTotal_or_Date3 > secondLastTotal_or_Date4) {
        //   maxTotal = lastTotal_or_Date3;
        // } else {
        //   maxTotal = secondLastTotal_or_Date4;
        // }
        // List<RetailTDTMDetail> retailTDTMDetailList = [];
        // RetailTDTMDetail retailTDTMDetail = RetailTDTMDetail();
        // //Get Current Month Data
        // for (int i = 0; i < totalTDTMList.length - 1; i++) {
        //   try {
        //     TotalTDTM item = totalTDTMList[i];
        //     retailTDTMDetail = RetailTDTMDetail();
        //     int percentRevenue = ((item.getCurrentMonthRevenue() * 100) /
        //             totalTDTMList[totalTDTMList.length - 1]
        //                 .getCurrentMonthRevenue())
        //         .round();
        //     retailTDTMDetail.setPercentHeight(percentRevenue);
        //     retailTDTMDetail.setTeamName(item.getCenter());
        //     retailTDTMDetail.setColorCode(CommonUtils.colorsList[i]);
        //   } on Exception catch (_) {
        //     print("No Data Available");
        //   }
        //   retailTDTMDetailList.add(retailTDTMDetail);
        // }
        // int percentHeight = (currentTotal_or_Date1 * 100 / maxTotal).round();
        // //drawGraphData(FirstMonthContainer, retailTDTMDetailList, percentHeight);
        // //RenderGraphWidget(value1: 11, value2: 22, value3: Colors.amber);

        // //Get previous month data
        // retailTDTMDetailList.clear();
        // for (int i = 0; i < totalTDTMList.length - 1; i++) {
        //   try {
        //     TotalTDTM item = totalTDTMList[i];
        //     retailTDTMDetail = RetailTDTMDetail();
        //     int percentRevenue = (item.getPreviousMonthRevenue() *
        //             100 /
        //             totalTDTMList[totalTDTMList.length - 1]
        ...
        //   retailTDTMDetailList.add(retailTDTMDetail);
        // }
        // percentHeight = (prevTotal_or_Date2 * 100 / maxTotal).round();
        // //drawGraphData(FirstMonthContainer, retailTDTMDetailList, percentHeight);
        ...
        //     TotalTDTM item = totalTDTMList[i];
        //     retailTDTMDetail = RetailTDTMDetail();
        //     int percentRevenue = (item.getLastMonthRevenue() *
        //             100 /
        //             totalTDTMList[totalTDTMList.length - 1]
        //                 .getLastMonthRevenue())
        //         .round();
        ...
        //   retailTDTMDetailList.add(retailTDTMDetail);
        // }
        // percentHeight = (lastTotal_or_Date3 * 100 / maxTotal).round();
        // //drawGraphData(ThirdMonthContainer, retailTDTMDetailList, percentHeight);

        // //Get Second Last Month Data
        ...
        //     TotalTDTM item = totalTDTMList[i];
        //     retailTDTMDetail = RetailTDTMDetail();
        //     int percentRevenue = (item.getSecondLastMonthRevenue() *
        //             100 /
        //             totalTDTMList[totalTDTMList.length - 1]
        //                 .getSecondLastMonthRevenue())
        //         .round();
        //     retailTDTMDetail.setPercentHeight(percentRevenue);
        //     retailTDTMDetail.setTeamName(item.getCenter());
        //     retailTDTMDetail.setColorCode(CommonUtils.colorsList[i]);
        ...
        //   retailTDTMDetailList.add(retailTDTMDetail);
        // }
        // percentHeight = (secondLastTotal_or_Date4 * 100 / maxTotal).round();
        // //drawGraphData(ThirdMonthContainer, retailTDTMDetailList, percentHeight);
